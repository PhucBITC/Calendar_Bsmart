                    ...
                    <div class="info-grid">
                        <div class="info-section">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">${user.fullName != null ? user.fullName : 'N/A'}</span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Phone Number:</span>
                                <span class="info-value">${user.phoneNumber != null ? user.phoneNumber : 'N/A'}</span>
                            </div>
                        </div>
                        ...
                        <div class="info-section">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value ${user.isActive() ? 'status-active' : 'status-inactive'}">
                                    ${user.isActive() ? 'Active' : 'Inactive'}
                                </span>
                            </div>
                            <div class="info-item">
