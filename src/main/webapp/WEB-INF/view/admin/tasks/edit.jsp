...
<body>
    <div class="container">
        ...
        <div class="form-container">
            <form method="POST" action="/admin/tasks/edit/${task.id}">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control" placeholder="Enter task description...">${task.description}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="user" name="user.id" class="form-control">
                        ...
                        <c:forEach var="user" items="${users}">
                            <option value="${user.id}" ${task.user != null && task.user.id == user.id ? 'selected' : ''}>
                                ${user.username} (${user.fullName != null ? user.fullName : 'N/A'})
                            </option>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="duration" name="duration" class="form-control" min="0" value="${task.duration}">
                </div>
                
                <div class="form-group">
                    <label for="estimatedDuration">Estimated Duration (minutes)</label>
                    <input type="number" id="estimatedDuration" name="estimatedDuration" class="form-control" min="0" value="${task.estimatedDuration}">
                </div>
