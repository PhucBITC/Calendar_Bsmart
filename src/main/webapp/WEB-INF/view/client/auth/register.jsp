    ...
    <div class="register-container">
        <div class="register-card">
            <div class="register-header">
                ...
                <p>Tạo tài khoản để sử dụng BSmart Calendar</p>
            </div>
            ...
            <div class="register-body">
                ...
                <!-- Form đăng ký -->
                <form:form method="post" action="/auth/register" modelAttribute="registrationDTO" id="registerForm">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <form:errors path="username" cssClass="text-danger validation-message d-block"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <form:errors path="email" cssClass="text-danger validation-message d-block"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <form:errors path="password" cssClass="text-danger validation-message d-block"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <form:errors path="confirmPassword" cssClass="text-danger validation-message d-block"/>
                            </div>
                        </div>
                    </div>
