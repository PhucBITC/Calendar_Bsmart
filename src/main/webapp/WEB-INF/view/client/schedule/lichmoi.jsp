                        ...
                        <div class="nav__date-info">
                            <div class="nav__controls">
                                <button class="button button--secondary desktop-only"
                                    data-nav-today-button>Today</button>
                ...
                <form class="form" data-event-form action="/schedule/save" method="post">
                    <div class="dialog__wrapper">
                        <div class="dialog__header">
                            ...
                            <button class="button button--icon button--secondary" type="button"
                        ...
                        <div class="dialog__content">
                            <div class="form__fields">
                                ...
                                <div class="form__field">
                                    ...
                                    <input class="input input--fill" id="title" name="description" type="text"
                                        placeholder="My awesome event!" required autofocus />
                                </div>

                                <div class="form__field">
                                    <label class="form__label" for="date">Date</label>
                                    <input class="input input--fill" id="date" name="dayOfWeek" type="date" required />
                                </div>
                        ...
                        <div class="event-details" data-event-details>
                            ...
                            <div class="event-details__content">
                                ...
                                <div class="event-details__time">
                                    ...
                                    <time data-event-details-start-time></time> - <time
                                        data-event-details-end-time></time>
                                </div>
                            </div>
                        </div>
                    </div>
